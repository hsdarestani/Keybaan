...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('formsscontract', '0005_iranprovinces_remove_contracts_contractid_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('EntryDate', models.DateTimeField(max_length=200, null=True, verbose_name='تاریخ ثبت رکورد')),
                ('CityID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='formsscontract.cities', verbose_name='شهر')),
            ],
            options={
                'verbose_name': 'جایگاه',
