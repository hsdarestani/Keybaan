...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('formsscontract', '0006_boardtypes_locations'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('BoardTypeID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='formsscontract.boardtypes', verbose_name='نوع تابلو')),
                ('LocationID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='formsscontract.locations', verbose_name='جایگاه')),
            ],
            options={
                'verbose_name': 'تابلو',
