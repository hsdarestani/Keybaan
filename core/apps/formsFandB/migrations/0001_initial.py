    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('EntryDate', models.DateTimeField(max_length=200, null=True, verbose_name='تاریخ ثبت رکورد')),
                ('ProviderTypeID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='formsFandB.commoditycategories', verbose_name='نوع تامین کننده')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('EntryDate', models.DateTimeField(max_length=200, null=True, verbose_name='تاریخ ثبت رکورد')),
                ('AgentRoleID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='formsFandB.roles', verbose_name='نقش')),
            ],
            options={
                'verbose_name': 'مسئول',
