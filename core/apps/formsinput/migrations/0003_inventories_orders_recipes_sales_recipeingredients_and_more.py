...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('formsinput', '0002_rename_agents_fagents'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('EntryDate', models.DateTimeField(max_length=200, null=True, verbose_name='تاریخ ثبت رکورد')),
                ('ProductTypeID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='formsinput.producttypes', verbose_name='نوع کالا')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('EntryDate', models.DateTimeField(max_length=200, null=True, verbose_name='تاریخ ثبت رکورد')),
                ('RecipeID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='formsinput.recipes', verbose_name='دستور پخت')),
            ],
            options={
                'verbose_name': 'فروش',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('EntryDate', models.DateTimeField(max_length=200, null=True, verbose_name='تاریخ ثبت رکورد')),
                ('DeliveryAgent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='formsinput.fagents', verbose_name='مسئول تحویل')),
                ('FromInventoryID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='formsinput.inventories', verbose_name='انبار')),
                ('ProcurementID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='formsinput.procurements', verbose_name='ردیف خرید')),
            ],
            options={
                'verbose_name': 'خروجی',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('InventoryID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='formsinput.inventories', verbose_name='انبار')),
                ('ProcurementID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='formsinput.procurements', verbose_name='ردیف خرید')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('EntryDate', models.DateTimeField(max_length=200, null=True, verbose_name='تاریخ ثبت رکورد')),
                ('ProcurementID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='formsinput.procurements', verbose_name='ردیف خرید')),
                ('ToInventoryID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='formsinput.inventories', verbose_name='انبار')),
                ('TransfereeAgent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='formsinput.fagents', verbose_name='مسئول تحویل')),
            ],
            options={
                'verbose_name': 'ورودی',
